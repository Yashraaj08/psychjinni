...
const stats = [
	{
		value: 342,
		suffix: "+",
		label: "Tailored wellness sessions designed to support unique needs.",
	},
	{
		value: 600,
		suffix: "+",
		label: "Individuals empowered to heal, grow, and thrive.",
	},
	{
		value: 89,
		suffix: "%",
		label: "Success rate in making mental health approachable and stigma-free.",
	},
	{
		value: 213,
		suffix: "+",
		label: "Moments of mindful connection, reflection, and self-discovery.",
	},
];
...
export default function StatsSection() {
	...
	return (
		<section
			ref={sectionRef}
			className="wave-bg relative py-16 px-4 sm:px-8 text-center"
		>
